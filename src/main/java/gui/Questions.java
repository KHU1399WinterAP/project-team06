...
public class Questions extends JFrame {
    ...
    private void initComponents() {
        ...
        //======== Questions ========
        {
            Questions.setMinimumSize(new Dimension(380, 605));
            Questions.setName("Dashbord");
            Questions.setMaximizedBounds(new Rectangle(580, 60, 380, 605));
            Questions.setResizable(false);
            Questions.setTitle("Dashbord");
            Questions.setBackground(new Color(0, 112, 192));
            Questions.setVisible(true);
            Questions.setIconImage(new ImageIcon(getClass().getResource("/main/resources/icons/Logo (1).jpg")).getImage());
            Questions.addWindowListener(new WindowAdapter() {
                @Override
                public void windowClosed(WindowEvent e) {
                    DashbordFrameWindowClosed(e);
                }
            });
            var QuestionsContentPane = Questions.getContentPane();
            ...
            GroupLayout QuestionsContentPaneLayout = new GroupLayout(QuestionsContentPane);
            QuestionsContentPane.setLayout(QuestionsContentPaneLayout);
            QuestionsContentPaneLayout.setHorizontalGroup(
                QuestionsContentPaneLayout.createParallelGroup()
                    .addComponent(Panel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            );
            QuestionsContentPaneLayout.setVerticalGroup(
                QuestionsContentPaneLayout.createParallelGroup()
                    .addComponent(Panel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            );
            Questions.pack();
            Questions.setLocationRelativeTo(Questions.getOwner());
        }
        // JFormDesigner - End of component initialization  //GEN-END:initComponents
    }

    // JFormDesigner - Variables declaration - DO NOT MODIFY  //GEN-BEGIN:variables
    private JFrame Questions;
