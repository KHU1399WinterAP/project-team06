...
public class GuiValidation {
    private static final Field USERNAME = new Field(USERNAME_MIN_LENGTH, USERNAME_MAX_LENGTH,
            GuiError.USERNAME_IS_EMPTY, GuiError.USERNAME_HAS_INVALID_LENGTH);
    private static final Field PASSWORD = new Field(PASSWORD_MIN_LENGTH, PASSWORD_MAX_LENGTH,
            GuiError.PASSWORD_IS_EMPTY, GuiError.PASSWORD_HAS_INVALID_LENGTH);
